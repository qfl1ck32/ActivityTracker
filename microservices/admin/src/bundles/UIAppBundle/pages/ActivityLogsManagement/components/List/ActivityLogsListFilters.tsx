...
import { ActivityLogListFiltersForm } from "../../config/ActivityLogListFiltersForm";

type ActivityLogsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const ActivityLogsListFilters = React.memo(ActivityLogsListFiltersBase);

export function ActivityLogsListFiltersBase(
  props: ActivityLogsListFiltersProps
) {
  ...
  const filterForm = use(ActivityLogListFiltersForm, { transient: true });
  filterForm.build();
