...
import { NoteModelCreateForm } from "../../config/NoteModelCreateForm";
import {
  NoteModel,
...
export function NoteModelsCreate() {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(NoteModelCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.note_models.create.header")}
