...
import { ActivityListFiltersForm } from "../../config/ActivityListFiltersForm";

type ActivitiesListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const ActivitiesListFilters = React.memo(ActivitiesListFiltersBase);

export function ActivitiesListFiltersBase(props: ActivitiesListFiltersProps) {
  ...
  const filterForm = use(ActivityListFiltersForm, { transient: true });
  filterForm.build();
