...
import { ActivityNoteCreateForm } from "../../config/ActivityNoteCreateForm";
import {
  ActivityNote,
...
export function ActivityNotesCreate() {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(ActivityNoteCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.activity_notes.create.header")}
